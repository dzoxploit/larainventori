...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="form-group row required">
            {!! Form::label("id_posisitions","nip",["class"=>"col-form-label col-md-3 col-lg-2"]) !!}
            <div class="col-md-8">
                {!! Form::text("id_posisitions",null,["class"=>"form-control".($errors->has('id_p')?" is-invalid":""),"autofocus",'placeholder'=>'Harga estimasi minimum','id'=>'harga_minimum']) !!}
