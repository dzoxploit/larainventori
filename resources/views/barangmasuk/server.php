...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-8 offset-md-2">
            <h1>{{isset($barangs)?'Add':'New'}} Kategori Data </h1>
            <hr/>
                {!! Form::open() !!}
        ...
        <div class="form-group row required">
        {!! Form::label("spesifikasi barang","spesifikasi_barang",["class"=>"col-form-label col-md-3 col-lg-2"]) !!}
        <div class="col-md-8">
    ...
    <div class="form-group row required">
            ...
            <div class="col-md-8">
                {!! Form::text("quantity",null,["class"=>"form-control".($errors->has('quantity')?" is-invalid":""),"autofocus",'placeholder'=>'quantity','id'=>'quantity']) !!}
